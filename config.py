...
API_ID=30706006 # Example: 1234567
API_HASH="fb01e8d10ef234bc013769c2e2f024a5" # Example: "abc123def456"

# Bot token (from @BotFather)
BOT_TOKEN="8846675803:AAFEtZ7dIePGIRnPBdl7KWdT2ybT8YNfdxQ" # Example: "123456789:ABCdef..."

# Storage channel ID (create a channel and add bot as admin)
BIN_CHANNEL=-1003432847224 # Example: -1001234567890

# Owner information (get ID from @userinfobot)
OWNER_ID=7460245198 # Your Telegram user ID. Example: 123456789

# Database connection string
DATABASE_URL="mongodb+srv://kipsas449_db_user:B7ozUo6ATjSZqXee@cluster0.3n48kw4.mongodb.net/?appName=Cluster0" # Example: "mongodb+srv://user:pass@host/db"
...
FORCE_CHANNEL_ID="-1002896296138" # Example: -1001234567890 (Leave empty if not needed)
...
UPSTREAM_REPO="https://github.com/Aadhi000/File-To-Link"
...
# Application name
NAME="WayneBots" # Bot application name
